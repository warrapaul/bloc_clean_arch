...
//   Future<void> _handleDummyPostsSearchQueryChanged(
//       DummyPostsSearchQueryChanged event, Emitter<DummyPostsSearchState> emit) async{
//     try {
...
//       if (event.immediateSearch) {
//         // Cancel the debounce timer and perform the search immediately
//         _debouncer.cancel();
//         emit(DummyPostsSearchLoading());
//         await _performSearch(event.query, emit);
//         return;
